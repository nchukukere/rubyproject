...
puts eresp# puts eresp.reservations# eresp.reservations.first# eresp.reservations[0]# puts eresp[: reservations][0][: reservation_id]# puts eresp[: reservations][0][: instances][0][: tags][0][: value]
